...
print(pc1)
#PC1 = Sangr?a, PC2 = Heridos no muertos civiles (Cuanto se salv? la gente), PC3 = Terroristas heridos *-1
...
plot(Psi[,eje1],Psi[,eje2], xlim=c(-1,7), ylim=c(-3,9))
...
plot(Psi[,eje1],Psi[,eje3], xlim=c(-1,7), ylim=c(-6,2))
axis(side=1, pos= 0, labels = F, col="red")
axis(side=3, pos= 0, labels = F, col="red")
axis(side=2, pos= 0, labels = F, col="red")
axis(side=4, pos= 0, labels = F, col="red")
...
plot(Psi[,eje2],Psi[,eje3], xlim=c(-3,9), ylim=c(-6,2))
axis(side=1, pos= 0, labels = F, col="red")
axis(side=3, pos= 0, labels = F, col="red")
axis(side=2, pos= 0, labels = F, col="red")
axis(side=4, pos= 0, labels = F, col="red")
...
#zooms
plot(Psi[,eje1],Psi[,eje2],type="n",xlim=c(min(X,0),max(X,0)),ylim=c(min(Y,0),max(Y,0)))
...
plot(Psi[,eje1],Psi[,eje2],type="n",xlim=c(-1,13), ylim=c(-5,5))
...
varcat=dd[,29]
plot(Psi[,1],Psi[,2],col=varcat,xlim=c(-1,20), ylim=c(-3,15), pch=16)
...
varcat=dd[,11]
plot(Psi[,1],Psi[,2],col=varcat, pch=16)
axis(side=1, pos= 0, labels = F, col="darkgray")
axis(side=3, pos= 0, labels = F, col="darkgray")
axis(side=2, pos= 0, labels = F, col="darkgray")
axis(side=4, pos= 0, labels = F, col="darkgray")
...
# category centroids
plot(Psi[,eje1],Psi[,eje2],type="n",xlim=c(-0.5,10),ylim=c(-3,3))
points(tapply(Psi[,eje1],dd[,11],mean),
       tapply(Psi[,eje2],dd[,11],mean), pch=16, col=seq(1,8,1))
legend("topright",levels(dd[,11]),pch=16,col=seq(1,8,1), cex=0.8)
