...
We can see that the majority of observations (2209) are very similar and are inside the same cluster. The others are distributed in different clusters. We think that the best approach is to cut the dendogram in 4 clusters as seen before.
